 ...
 * @category Libraries
 *
 * @link     http://php.net/manual/en/class.arrayaccess.php Interface to provide accessing objects as arrays.
 */
class Container extends CApplicationComponent implements ArrayAccess
{
    /**
